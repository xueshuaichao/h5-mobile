...
export default {
    // 获取课程列表
    getCourselist(param) {
        return axios.get('/courseCenter/v1/course/student/findAppCourseStudentList', param);
    },
    // 获取课程分类
    getCourseCategory() {
        return axios.get('/courseCenter/v1/course/student/getCourseCategory');
    },
    // 获取课程详情
    findById(param) {
        return axios.get(
            `/courseCenter/v1/course/student/findStudentCourseInfoById?id=${param}`
        );
    },
    // 获取课程目录
    findCourseItemByCourseId(data) {
        return axios.get('/courseCenter/v1/course/student/findStudentCourseItem', data);
    },
    // 加入选学
    startStudy(data) {
        return axios.post(
            `/courseCenter/v1/userCourseRecord/student/course/signup?courseId=${data}`,
        );
    },
    // 提交评价
    submitCourseRatingForm(data) {
        return axios.post(
            '/courseCenter/v1/courseRatingForm/student/submitCourseRatingForm',
            data,
        );
    },
    ...
    saveLearningLog(data) {
        return axios.post(
            '/courseCenter/v1/courseLearningLog/student/saveLearningLog',
            data,
        );
    },
